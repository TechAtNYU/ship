$(document).ready(function () {
	var Ship = {
		...
		"demodaysLink": function () {
			$(".demodays__link").each(function () {
				var text = $(this).text().split(" ");
				var month = text[0].toLowerCase();
				var year = text[1];
				var num;
				...
				var assembled =  "http://demodays.co/archive/" + num + "/" + year + "/";
				$(this).wrap("<a href='" + assembled + "' target='_blank' />").prepend('<span class="ion-wand" data-pack="default" data-tags="images, levels, light, dark, settings"></span> ');
			});
		}
	}
	Ship.init();
