		...
		header.hover( function() {
			...
			switch(current) {
				case 0:
					...
					break;
				case 1:
					test = "url(/lib/img/bowery.jpg)";
					break;
				case 2:
					test = "url(/lib/img/phys.jpg)";
					break;
				case 3:
					test = "url(/lib/img/grantophone.jpg)";
					break;
				case 4:
					test = "url(/lib/img/hotdogs.jpg)";
					break;
				case 5:
					test = "url(/lib/img/raise-cache.jpg)";
					break;
				case 6:
			...
			function() { $("header.main").css("background-image", "url(/lib/img/branch.jpg)");	
